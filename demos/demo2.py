"""
Same as demo1.py, but generates the Laguerre polynomials.
...
# Let's plot them
plt.plot(X, phi)
plt.title('Laguerre Polynomials', fontsize=16)
...
plt.plot(X, dphi)
plt.title('Derivatives of Laguerre Polynomials', fontsize=16)
plt.xlabel('$x$', fontsize=16)
