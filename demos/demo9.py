"""
Generate the Shifted Hermite polynomials using a scipy.stats random variable.
This particular demo generates the Shifted Hermite polynomials.
...
rv = scipy.stats.norm(loc=-5., scale=2.5)
# Construct it:
...
# Let's plot them
plt.plot(X, phi)
plt.title('Shifted Hermite Polynomials', fontsize=16)
...
plt.plot(X, dphi)
plt.title('Derivatives of Shifted Hermite Polynomials', fontsize=16)
plt.xlabel('$x$', fontsize=16)
