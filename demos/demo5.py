"""
Same as demo1.py, but generates the Jacobi polynomials.
...
# Pick the alpha and beta of the Jacobi polynomial
alpha = 2.
beta = 5.
...
# Let's plot them
plt.plot(X, phi)
plt.title('Jacobi Polynomials', fontsize=16)
...
plt.plot(X, dphi)
plt.title('Derivatives of Jacobi Polynomials', fontsize=16)
plt.xlabel('$x$', fontsize=16)
